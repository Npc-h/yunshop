	...
	<div class="member-center clearfix">
		...
		<div class="member-right fr">
			<div class="member-head">
				<div class="member-heels fl"><h2>账户信息</h2></div>
			</div>
			<div class="member-border">
				...
				<div class="member-caution clearfix">
					<ul>
						<li class="clearfix">
							<div class="warn1"></div>
							<div class="warn2">我的真实名字</div>
							<div class="warn3"><font size="4">${user.uname}</font></div>
							
						</li>
						<li class="clearfix">
							<div class="warn1"></div>
							<div class="warn2">email</div>
							<div class="warn3"><font size="5">${user.uemail}</font></div>
						</li>
						<li class="clearfix"> 
							<div class="warn6"></div>
							<div class="warn2">联系电话号码</div>
							<div class="warn3"><font size="5">${user.utelephone}</font></div>
							
						</li>
						<li class="clearfix">
							<div class="warn6"></div>
							<div class="warn2">生日</div>
							<div class="warn3"><font size="5">${user.ubirthday}</font></div>
							
						</li>
							<li class="clearfix">
							<div class="warn6"></div>
							<div class="warn2">性别</div>
							<div class="warn3"><font size="5">${user.usex}</font></div>
							<div class="warn4"><a href="${pageContext.request.contextPath}/forward.do?type=myself">去完善你的信息</a> </div>
						</li>
					</ul>
