...
<div class="containers center"><div class="pc-nav-item"><a href="#">首页</a> &gt; <a href="#">会员中心 </a> &gt; <a href="#">我的收藏</a></div></div>
<section id="member">
	<div class="member-center clearfix">
		...
		<div class="member-right fr">
			<div class="member-head">
				<div class="member-heels fl"><h2>收藏记录</h2></div>
			</div>
			<div class="member-border">
				<div class="member-form clearfix">
					<form>
						<input class="text-news" placeholder="收藏商品关键字" type="text">
		...
		<div class="pc-center-he">
			...
			<div class="pc-list-goods"style="width: 967px;">
				<div class="xsq_deal_wrapper pc-deal-list clearfix">
				 	<c:forEach var="productLove" items="${productLove}"> 
					<a class="saleDeal" href="">
						<div class="dealCon"><img class="dealImg" src="${productLove.pimage}" alt=""></div>
						<div class="title_new"><p class="word" title="【京东超市】福临门 葵花籽原香食用调和油5L 中粮出品"><span class="baoyouText">[包邮]</span>${productLove.pdesc}</p></div>
						<div class="dealInfo"><span class="price">¥<em>${productLove.pshop_price}</em></span></div>
					</a>
					 </c:forEach>
				</div>
			</div>
