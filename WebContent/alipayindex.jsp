		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post>
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject"  value="${oid1}" />
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="${cart.total}" />
					</dd>
					<hr class="one_line">
					<dt>备注：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody"  value="${user.username}"/>
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
